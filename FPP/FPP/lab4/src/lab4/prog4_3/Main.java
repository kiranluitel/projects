...
import lab4.prog4_3.employeeinfo.Account;
import lab4.prog4_3.employeeinfo.Employee;
...
public class Main {
	...
	String getFormattedAccountInfo(Employee[] arr){
		...
		for(int i=0;i<arr.length;i++) {
			output+=String.format("%n%nACCOUNT INFO FOR %s%n%n",arr[i].getName());
			output+=arr[i].getFormattedAcctInfo();
