...
public class UserIO extends JFrame {
	...
	private void initializeWindow() {
		...
		setSize(GuiControl.SCREEN_WIDTH+100, GuiControl.SCREEN_HEIGHT+100);
...
//		private int k;
		...
		public void actionPerformed(ActionEvent evt) {
			...
			if (inputString.equalsIgnoreCase("Y")) {
				Main accInfo = new Main();
				String info = accInfo.getMyData();
				
				setOutputValue("The account information are: \n"+info);
			} 
				...
				setOutputValue("Type only 'y' or 'n' \n");
			}
		}
	}
